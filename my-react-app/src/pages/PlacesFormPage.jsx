    ...
    return (
        <div>
            ...
            <form onSubmit={savePlace}>
                ...
                <input type="text" value={title} onChange={ev => setTitle(ev.target.value)} placeholder="title, for example: My lovely appartament" />
                ...
                <div className="grid mt-2 gap-2 grid-cols-2 md:grid-col-4 lg:grid-cols-6">
